...
```sh
yarn add https://github.com/ondato/ondato-sdk-react-native/releases/download/2.5.8/ondato-sdk-react-native-2.5.8.tgz
or
npm install https://github.com/ondato/ondato-sdk-react-native/releases/download/2.5.8/ondato-sdk-react-native-2.5.8.tgz
```

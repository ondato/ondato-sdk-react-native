...
```sh
yarn add https://github.com/ondato/ondato-sdk-react-native/releases/download/2.5.6/ondato-sdk-react-native-2.5.6.tgz
or
npm install https://github.com/ondato/ondato-sdk-react-native/releases/download/2.5.6/ondato-sdk-react-native-2.5.6.tgz
```
